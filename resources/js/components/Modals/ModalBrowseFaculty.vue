<template>
    <div>
        <b-field label="Select Faculty"
                 :type="this.errors.faculty_id ? 'is-danger':''"
...
export default {
    ...
    methods: {
        loadAsyncData() {
            ...
            this.loading = true;
            axios.get(`/cpanel/get-faculty?${params}`).then(({data}) => {
                this.data = [];
        ...
        selectData(dataRow){
            ...
            this.$emit('browseFaculty', dataRow);
        }
