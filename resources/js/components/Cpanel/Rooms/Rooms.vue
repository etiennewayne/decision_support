                ...
                <div class="column is-8">
                    <div class="box">
                        ...
                        <b-table
                            ...
                            <b-table-column field="room_desc" label="Room Description" v-slot="props">
                                {{ props.row.room_desc }}
                            </b-table-column>
                            ...
                            <b-table-column label="Action" v-slot="props">
                                <div class="is-flex">
                                    <b-tooltip label="Edit" type="is-primary">
                                        <b-button class="button is-small mr-1 is-primary" tag="a" icon-right="pencil" @click="getData(props.row.room_id)"></b-button>
                                    </b-tooltip>
                                    <b-tooltip label="Delete" type="is-primary">
                                        <b-button class="button is-small mr-1 is-danger" icon-right="delete" @click="confirmDelete(props.row.room_id)"></b-button>
                                    </b-tooltip>
                                </div>
                            </b-table-column>
                        </b-table>
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/cpanel/get-rooms?${params}`)
                .then(({ data }) => {
                    this.data = [];
        ...
        */
        ...
        submit: function(){
            if(this.global_id > 0){
                //update
                axios.put('/cpanel/rooms/'+this.global_id, this.fields).then(res=>{
                ...
                //INSERT HERE
                axios.post('/cpanel/rooms', this.fields).then(res=>{
        ...
        deleteSubmit(delete_id) {
            axios.delete('/cpanel/rooms/' + delete_id).then(res => {
                this.loadAsyncData();
            }).catch(err => {
                if (err.response.status === 422) {
                    this.errors = err.response.data.errors;
        ...
        getData: function(data_id){
            ...
            axios.get('/cpanel/rooms/'+data_id).then(res=>{
