                ...
                <div class="column is-8">
                    <div class="box">
                            ...
                            <div class="level-right">
                                <div class="level-item">
                                    <b-field label="Search">
                                        <b-input type="text"
                                                 v-model="search.faculty_lastname" placeholder="Search Lastname"
                        ...
                        <b-table
                            ...
                            <b-table-column field="faculty_lname" label="Name" v-slot="props">
                                {{ props.row.faculty_lname }}, {{ props.row.faculty_fname }} {{ props.row.faculty_mname }}
                            </b-table-column>
                            ...
                            <div class="columns">
                                <div class="column">
                                    <b-field label="Lastname" label-position="on-border"
                                             :type="this.errors.faculty_lname ? 'is-danger':''"
                                             :message="this.errors.faculty_lname ? this.errors.faculty_lname[0] : ''">
                                        <b-input v-model="fields.faculty_lname"
                                                 placeholder="Lastname" required>
                                        </b-input>
                                    </b-field>
                                    <b-field label="Firstname" label-position="on-border"
                                             :type="this.errors.faculty_fname ? 'is-danger':''"
                                             :message="this.errors.faculty_fname ? this.errors.faculty_fname[0] : ''">
                                        <b-input v-model="fields.faculty_fname"
                                                 placeholder="Firstname" required>
                                        </b-input>
                                    </b-field>

                                    <b-field label="Middlename" label-position="on-border"
                                             :type="this.errors.faculty_mname ? 'is-danger':''"
                                             :message="this.errors.faculty_mname ? this.errors.faculty_mname[0] : ''">
                                        <b-input v-model="fields.faculty_mname"
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/cpanel/get-courses?${params}`)
                .then(({ data }) => {
                    this.data = [];
